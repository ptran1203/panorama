...
class Image_Stitching():
    ...
    def registration(self,img1,img2):
        ...
        matcher = cv2.BFMatcher() # Brute-Force Matcher using L2 norm to calculate distance of one in the first one to all in the second one and return a closet one
